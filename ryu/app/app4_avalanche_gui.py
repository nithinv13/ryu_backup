...
def tree_ports_all(sh, dhs, flow_rate, algo_runner_obj):
	global ports
	count = 0
	ports.clear()
...
def caller_function(entries, algo_runner_obj):
	...
	count = tree_ports_all(source, destination, flow_rate, algo_runner_obj)
...
if __name__ == "__main__":
	#filejson = open("../topo/q_fattree_branch_aware.json")
